...
function Home() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center pt-5 bg-gray-50">
            <NavBar/>
            <p className="lg:text-4xl md:text-2xl sm:text-xl font-bold">Welcome back, Dev Astra</p>
            <p className="text-md md:text-lg lg:text-lg text-gray-500 mt-4"> Discover amazing stories, insights, and ideas from our community of writers.</p>
            <div className=" flex gap-10 justify-around mt-5 ">
                <button className="lg:px-10 lg:py-4 md:px-10 md:py-4 sm:px-4 sm:py-3 cursor-pointer bg-blue-700 hover:bg-blue-900 shadow-md text-white rounded-md">Write a New Post</button>
                <button className="lg:px-10 lg:py-4 md:px-10 md:py-4 sm:px-4 sm:py-3 cursor-pointer bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-md" >View My Posts</button>
            </div>
